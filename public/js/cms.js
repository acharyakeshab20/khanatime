...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bootstrap */ "./resources/js/cms/bootstrap.js");
...
__webpack_require__(/*! ./script */ "./resources/js/cms/script.js");
...
$(function () {
  ...
  $('#addMore').click(function () {
    ...
    ++i;
    $('#addOrderColumn').append('<div class="row" id="sass">' + '<div class="col-md-2">  <input type="text" name="addMoreInputFields[0][sku]" id="sku" class="form-control"> </div> ' + '<div class="col-md-2"> <select name="addMoreInputFields[0][name]" id="productname" class="form-control"> </select> </div>' + ' <div class="col-md-2"> <input type="number" name="addMoreInputFields[' + i + '][qty]" id="qty" placeholder="enter your  qty" class="form-control"> </div> ' + '<div class="col-md-2"> <input type="number" name="addMoreInputFields[' + i + '][rate]" id="rate" placeholder="enter your  product rate" class="form-control"> </div> ' + '<div class="col-md-2"> <input type="text" name="addMoreInputFields[' + i + '][address]" id="address" class="form-control"></div>' + ' <div class="col-md-2"><button type="button" class="btn btn-outline-danger remove">Delete</button></div> ' + '</div>');
    // console.log('')
  });
...
/******/ 	__webpack_require__.O(undefined, ["css/cms","css/front"], () => (__webpack_require__("./resources/js/cms/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/cms","css/front"], () => (__webpack_require__("./resources/sass/front/app.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/cms","css/front"], () => (__webpack_require__("./resources/sass/cms/app.scss")))
